...
1. 量子力学の全構造、一般Born則、Wallstrom問題、連続スペクトルの導出。
...
2. Q3-2からQ3-5として、M37複素振幅場とM42実現配置を位相量子化、束縛状態選択、トンネルの初回通過、2重スリット完全検出周期へ拡張する。
