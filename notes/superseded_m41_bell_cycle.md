# 置換済みM41 Bell測定周期と前提監査

この文書はdraft-45Aまで本文第5章だったM41の記録である。draft-45BではM48のR151--R156が固定singlet型の受渡し、2翼matching、局所記録、弱開放帰還を閉じるため、M41を現行Q2-2因果鎖から外した。R107--R111、R121の数学的内容は撤回しないが、現行達成根拠には使わない。
