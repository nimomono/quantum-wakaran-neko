...
> **現行注記（draft-127）**：本文中の旧作用殻測定経路や旧Q3粒子経路は収録当時の責務を示す。現在はQ1/Q2-2の逐次結果形成をM65/R181D、Q2-1/Q2-3/Q2-4のterminal readoutをM66/R205--R206、Q3の粒子位置をM64/R203A--R203D/R161/R185が担う。R192はdraft-127で責務消滅により退役した。最新の系譜は `theory_lineage.md` を参照する。
