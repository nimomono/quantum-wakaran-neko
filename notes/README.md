...
| `superseded_q3_poisson_microphysics.md` | draft-95でM57採用時に分離 | R162 open-PoissonをQ3の基礎的存在論としていた旧責務の退役記録 | R162をideal stochastic referenceへ縮約し、M57/R195を現行ミクロ物理層へ採用したため |
