...
| `rejected_forward_weighting_models.md` | draft-10 第7.10節、第8.5節、第8.9節、付録C.11 | M6・M7の不採用記録 | 順時間的共有浴と待ち時間は Bell 試行頻度を作らない |
| `complementary_terminal_halfspaces.md` | draft-10 第8.4節、付録C.4 | M9の不採用記録 | 相補半空間の等重み平均は余弦項を消す |
