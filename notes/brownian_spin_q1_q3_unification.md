...
draft-112以後、現行Q3-2の物理主線はM37/R86 signal、M64/R203A--R203D、R161、R185である。R162はideal open-jump referenceとして保持する。M60/M61は旧Hamiltonian実現として退役した。M56がR161実現同値まで閉じることは未証明であり、本メモはspin-only代替研究線として保存する。draft-120以後のQ1/Q2測定正本はM65/R181Dであり、旧R191参照は歴史記録として読む。最新の置換系譜は `theory_lineage.md` を参照する。
