...
draft-105以後、現行Q3-2のミクロ物理主線はM37/M54信号、M61/R200A--R200C/R200、M60統一二成分chiral媒体＋moving-bath tracer、R198A--R198D、R199A、R195A、R196A--R196C、R161、R185である。R162はideal open-jump referenceとして保持する。M56がR161実現同値まで閉じることは未証明であり、本メモはspin-only代替研究線として保存する。M37とR191の責務は変更しない。
