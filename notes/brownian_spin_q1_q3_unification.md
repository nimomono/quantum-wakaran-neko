...
draft-112以後、現行Q3-2の物理主線はM37/R86 signal、M64/R203A--R203D、R161、R185である。R162はideal open-jump referenceとして保持する。M60/M61は旧Hamiltonian実現として退役した。M56がR161実現同値まで閉じることは未証明であり、本メモはspin-only代替研究線として保存する。M37とR191の責務は変更しない。
