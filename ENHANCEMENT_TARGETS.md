...
開放ミクロ方程式を基本方程式として直接定める場合は、白色雑音をHamiltonian無限浴から再導出することをA1の必須条件としない。ただし、その方程式をHamiltonian浴から導出したと主張する場合は、浴、結合、縮約条件と誤差を別途示す。理想白色雑音を用いる場合も、物理回路実装Bでは有限帯域の雑音源へ落とす。
