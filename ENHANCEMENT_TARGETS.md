...
| Q3-1 | 達成 | 未監査 | — | — | — | — | M37、R86 |
| Q3-2 | 達成 | 未監査 | — | — | — | — | M57、R195A、R196A--R196C、R161、R185 |
...
従来の強化課題であるQ1/Q2の完全周期収支、共通浴統合、M58 common process--時計--終位置記録--resetの単一反復周期統合、連続空間一様極限、多粒子拡張、有限閉鎖Hamiltonian化は引き続き保持する。これらはA/B/Sの横断的または上位の実装強化課題として管理する。
