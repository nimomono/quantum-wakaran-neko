...
| Q3-1 | 部分達成 | 未監査 | — | — | — | — | M37、R86、M60、R198A--R198D、R199A |
| Q3-2 | 部分達成 | 未監査 | — | — | — | — | M60、R195A、R196A--R196C、R198A--R198D、R199A、R161、R185 |
...
Q3-1-A1とQ3-2-A1は、M60/R198A--R198Cによりtracerに付随する実Duffing内部自由度、同一二成分chiral媒体のnonlinear core、有限交換補正、ballistic leadまで明示した。R198Dの具体的core sectorに対するfinite-time mixing/homogenization witnessと、R199Aのcore--lead同時parameter witnessが未閉鎖なので部分達成とする。R199Bは同じ2-action pairのchiral responseを統合強化として与えるが、A1完全達成の代替にはしない。Q3-1-A2/Q3-2-A2はM60のDuffing＋統一chiral媒体＋moving bath-frame＋equilibrium bathそのものの直接数値再現が未実施なので未監査のままとする。
