...
| Q1-2 | 達成 | M54のW2静的状態構成 | R187によるM37のW2制御用信号系＋R191ブラウン巨視的スピン読出し接続部 | Q1 W型2モード測定・Zeno手順（旧M47） | R140、R143--R144、R181A、R181D、R187、R189A--R189C、R191 | Born分布、同軸反復分布、異軸逐次分布と有限2回Zeno証人を導出。2結果主線はR191。全測定部分系の単一ミクロ装置統合は強化課題 |
