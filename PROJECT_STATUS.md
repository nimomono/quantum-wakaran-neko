...
| 識別 | 分類 | 使用する共通層 | 役割と限界 |
|---|---|---|---|
| Q1 W型2モードprotocol（旧M47） | 系列固有protocol | M54 W2 static profile | R181A、R140、R161/R162 static、R170/R181Dの深さ1、R143、R144をW型分析器へ合成する。M47は履歴追跡用の旧IDであり、現行模型一覧では独立模型として数えない |
