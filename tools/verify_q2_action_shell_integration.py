...
def main() -> None:
    ...
    checks.append(record_max("r165_central_joint_born_error", maximum_joint_error, 3.0e-14))
    checks.append(record_max("r165_row_marginal_error", maximum_row_error, 3.0e-14))
    checks.append(record_max("r165_row_conditional_error", maximum_conditional_error, 3.0e-14))
    ...
    checks.append(record_equal("m49_operational_sampler_pair_count_error", 16 + 2 + 4 + 4 + 8, 34.0))
