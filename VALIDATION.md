...
- ページ数: 190
- 用紙: A4
- ファイルサイズ: 1,381,299 bytes
- SHA-256: `eebc1a709607371d55cefe3ef91b1464f27c707dfffdfa26adf23a1a0643bb8e`
...
全 190 ページを低解像度コンタクトシートで通覧した。さらに、物理ページ 1--10、38--48、70--78、132--138、173--190 を高解像度で確認し、表紙、目次、第4章のM41整理箇所、第5章のM48境界、第8章の誤差表、付録Fの参照修正、付録Jの状態表を重点監査した。
