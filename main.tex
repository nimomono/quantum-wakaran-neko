...
\tightlist
\item
  有限2成分場と粒子の位相接続から、十分準備された有限時間発展に対する弱 Schrödinger 型縮約を記述する。
\item
  2モード作用殻の Liouville 流束から、位置入口標本化の線形重みを得る。
\item
  反対称対モード、局所分析器、共通未来比較器、共通境界測度から Bell 型共同統計を得る。
\end{enumerate}
...
\hypertarget{ux540cux30582ux6210ux5206ux5834ux306eux56faux5b9aux30e2ux30fcux30c9}{%
\section{同じ2成分場の固定モード}\label{ux540cux30582ux6210ux5206ux5834ux306eux56faux5b9aux30e2ux30fcux30c9}}
...
\hypertarget{ux7a2eux985eux306eux6e96ux5099ux6761ux4ef6}{%
\section{3種類の準備条件}\label{ux7a2eux985eux306eux6e96ux5099ux6761ux4ef6}}
...
\tightlist
\item
  有限セル2成分場または共通2次形式領域を持つ連続極限。
\item
  固定規格化と固定全位相作用。
\item
  実数値で下から有界な外部位置ポテンシャル。
\item
  初期高速整合と初期コヒーレント集中。
\item
  各標本の有効複素場方程式に対する積分可能な双対残差上界とエネルギー残差上界。
\item
  初期密度同期と、粒子・場流束差の時間積分上界。
\item
  有限観測時間と一様エネルギー上界。
\item
  振幅勾配係数と保存作用の係数整合。
...
\tightlist
\item
  2つの固定源チャンネルが反対称対モードを準備する。
\item
  左右の局所分析器が局所モードだけを回転する。
\item
  結果枝作用 \(K_{AB}\) が余弦則を持つ。
\item
...
\item
  任意初期分布からのコヒーレント集中。
\item
  閉鎖 Hamiltonian 流による永久吸引。
\item
  長時間一様な Schrödinger 型極限。
\item
  一般の節生成、消滅、再結合。
\item
  任意初期状態からの励起状態選択。
...
\hypertarget{ux6709ux96502ux6210ux5206ux5834ux3068ux6e96ux5099ux6e08ux307fux4f4eux901fux9818ux57df}{%
\chapter{有限2成分場と準備済み低速領域}\label{ux6709ux96502ux6210ux5206ux5834ux3068ux6e96ux5099ux6e08ux307fux4f4eux901fux9818ux57df}}

\begin{statusbox}
位置づけ：有限セルの正準構造、保存全位相作用、固定作用平方分解、厳密規格化下の局所座標 Hamiltonian は厳密結果である。高速整合は限定模型で部分的に準備できる。初期コヒーレント集中と粒子・場同期は独立の準備条件である。
\end{statusbox}

\hypertarget{ux5927ux57dfux5909ux6570ux3068ux5c40ux6240ux6975ux5ea7ux6a19}{%
\section{大域変数と局所極座標}\label{ux5927ux57dfux5909ux6570ux3068ux5c40ux6240ux6975ux5ea7ux6a19}}
...
\hypertarget{ux898fux683cux5316ux3068ux4fddux5b58ux5168ux4f4dux76f8ux4f5cux7528}{%
\section{規格化と保存全位相作用}\label{ux898fux683cux5316ux3068ux4fddux5b58ux5168ux4f4dux76f8ux4f5cux7528}}
...
\hypertarget{ux56faux5b9aux4f5cux7528ux4e0bux306eux5e73ux65b9ux5206ux89e3}{%
\section{固定作用下の平方分解}\label{ux56faux5b9aux4f5cux7528ux4e0bux306eux5e73ux65b9ux5206ux89e3}}
...
\hypertarget{ux9ad8ux901fux6574ux5408}{%
\section{高速整合}\label{ux9ad8ux901fux6574ux5408}}
...
\hypertarget{ux9ad8ux901fux6574ux5408ux306eux6e96ux5099ux6a5fux69cb}{%
\section{高速整合の準備機構}\label{ux9ad8ux901fux6574ux5408ux306eux6e96ux5099ux6a5fux69cb}}
...
\hypertarget{ux30b3ux30d2ux30fcux30ecux30f3ux30c8ux96c6ux4e2d}{%
\section{コヒーレント集中}\label{ux30b3ux30d2ux30fcux30ecux30f3ux30c8ux96c6ux4e2d}}
...
\hypertarget{ux5834ux5f37ux5ea6ux5834ux6d41ux675fux3068ux7c92ux5b50ux540cux671f}{%
\section{場強度・場流束と粒子同期}\label{ux5834ux5f37ux5ea6ux5834ux6d41ux675fux3068ux7c92ux5b50ux540cux671f}}
...
\hypertarget{ux5916ux90e8ux4f4dux7f6eux30ddux30c6ux30f3ux30b7ux30e3ux30eb}{%
\section{外部位置ポテンシャル}\label{ux5916ux90e8ux4f4dux7f6eux30ddux30c6ux30f3ux30b7ux30e3ux30eb}}
...
\item
  \(V(x,t)\) は実数値で下から有界である。
\item
  \(H_V(t)\) は自己共役であるか、閉じた半有界2次形式を持つ。
\item
  時間依存の場合は有限観測時間で共通形式領域 \(\mathcal Q\) を持つ。
\item
  対応する発展作用素がエネルギーノルムで有限時間安定である。
\item
  境界条件を固定する。
\end{enumerate}
...
\hypertarget{ux6e96ux5099ux6e08ux307fux521dux671fux96c6ux56e3}{%
\section{準備済み初期集団}\label{ux6e96ux5099ux6e08ux307fux521dux671fux96c6ux56e3}}
...
\tightlist
\item
  規格化と全位相作用のセクターが固定されている。
\item
  \(\varepsilon_{\rm fast}(0)\) が小さい。
\item
  \(\varepsilon_{\rm coh}(0)\) が小さい。
\item
  \(\|\rho(0)-q(0)\|_{H^{-1}}\) が小さい。
\item
  観測窓における粒子・場流束差の時間積分に上界がある。
\item
  一様な場エネルギー上界がある。
\item
  代表場の時間位相を連続に選べる非零重なりがある。
\end{enumerate}

1から3を準備する完成した有限 Hamiltonian 装置はまだない。付録Eと付録Fは2の一部だけを扱い、第4章は4の分布部分だけを扱う。第3章の有限時間定理は、この不足を仮定として明示した上で、観測窓内の安定性を述べる。

\hypertarget{ux6709ux9650ux6642ux9593ux5f31-schruxf6dinger-ux578bux7e2eux7d04ux7bc0ux52b1ux8d77ux72b6ux614b}{%
\chapter{有限時間弱 Schrödinger 型縮約、節、励起状態}\label{ux6709ux9650ux6642ux9593ux5f31-schruxf6dinger-ux578bux7e2eux7d04ux7bc0ux52b1ux8d77ux72b6ux614b}}

\begin{statusbox}
位置づけ：コヒーレント縮約集合上の Madelung 作用と、その変分は厳密結果である。各標本の弱縮約残差を仮定した有限時間安定性と弱密度同期は近似結果である。現行ミクロ模型から節近傍を含む残差上界を導く部分は未完成である。
\end{statusbox}

\hypertarget{ux6709ux52b9ux8907ux7d20ux5834ux306eux4f4dux76f8ux5411ux304d}{%
\section{有効複素場の位相向き}\label{ux6709ux52b9ux8907ux7d20ux5834ux306eux4f4dux76f8ux5411ux304d}}
...
\hypertarget{ux30b3ux30d2ux30fcux30ecux30f3ux30c8ux7e2eux7d04ux96c6ux5408ux4e0aux306eux4f5cux7528}{%
\section{コヒーレント縮約集合上の作用}\label{ux30b3ux30d2ux30fcux30ecux30f3ux30c8ux7e2eux7d04ux96c6ux5408ux4e0aux306eux4f5cux7528}}
...
\begin{theorem}[縮約集合上の Madelung 作用]
理想縮約条件と係数整合
...
\hypertarget{ux5f31ux7e2eux7d04ux6b8bux5dee}{%
\section{弱縮約残差}\label{ux5f31ux7e2eux7d04ux6b8bux5dee}}
...
\hypertarget{ux4e3bux5b9aux74061}{%
\section{主定理1}\label{ux4e3bux5b9aux74061}}

\begin{theorem}[準備済み集団の条件付き有限時間弱縮約]
...
\hypertarget{ux5834ux5f37ux5ea6ux5834ux6d41ux675fux306eux96c6ux4e2d}{%
\section{場強度・場流束の集中}\label{ux5834ux5f37ux5ea6ux5834ux6d41ux675fux306eux96c6ux4e2d}}
...
\hypertarget{ux7c92ux5b50ux5bc6ux5ea6ux3068ux306eux5f31ux540cux671f}{%
\section{粒子密度との弱同期}\label{ux7c92ux5b50ux5bc6ux5ea6ux3068ux306eux5f31ux540cux671f}}
...
\hypertarget{ux7bc0ux3092ux542bux3080ux5927ux57dfux5f31ux5f62ux5f0f}{%
\section{節を含む大域弱形式}\label{ux7bc0ux3092ux542bux3080ux5927ux57dfux5f31ux5f62ux5f0f}}
...
\hypertarget{ux7bc0ux5916ux306e-madelung-ux8868ux793aux3068ux5faaux74b0ux91cfux5b50ux5316}{%
\section{節外の Madelung 表示と循環量子化}\label{ux7bc0ux5916ux306e-madelung-ux8868ux793aux3068ux5faaux74b0ux91cfux5b50ux5316}}
...
これは単価な基礎場と非零経路を仮定した条件付き循環量子化である。節の生成・消滅時の巻数変化、全ての物理的初期流れを単価場から準備すること、節近傍の接続極限は未完成である。従って Wallstrom 問題への全面的回答ではない \cite{wallstrom1994}。

\hypertarget{ux5bfeux79f0ux6027ux30bbux30afux30bfux30fcux3068ux52b1ux8d77ux72b6ux614b}{%
\section{対称性セクターと励起状態}\label{ux5bfeux79f0ux6027ux30bbux30afux30bfux30fcux3068ux52b1ux8d77ux72b6ux614b}}
...
\begin{corollary}[対称性で保護された固有状態の条件付き包含]
...
\item
  節の生成、消滅、再結合。
\item
  \(H^1\) 型集中だけから節集合の形と個数を保存すること。
\end{enumerate}

\hypertarget{nelson-ux8868ux793aux3068ux306eux95a2ux4fc2}{%
\section{Nelson 表示との関係}\label{nelson-ux8868ux793aux3068ux306eux95a2ux4fc2}}
...
と置けば、縮約作用は Nelson の現在速度・浸透速度表示と同じ係数構造を持つ \cite{nelson1966,guerra_morato1983,yasue1981,zambrini1986,knorst_lopes2024}。これは有効作用の別表示であり、実在する前進・後退 Markov 過程の導出ではない。配置拡散から同じ構造を得る補助経路は付録Dに置く。

\hypertarget{ux529bux5b66ux7684ux5230ux9054ux70b9}{%
\section{力学的到達点}\label{ux529bux5b66ux7684ux5230ux9054ux70b9}}
...
\item
  制限作用上の Madelung 構造。
\item
  双対残差とエネルギー残差を仮定した代表複素場とコヒーレント分散の有限時間評価。
\item
  流束差上界を仮定した弱密度同期評価。
\item
  節を含む大域複素弱形式と、節外の Madelung 表示・条件付き循環量子化。
\item
  対称性で保護された固有状態の条件付き包含。
\end{enumerate}
...
\hypertarget{ux521dux671fux5bc6ux5ea6ux540cux671fux3068ux306eux95a2ux4fc2}{%
\section{初期密度同期との関係}\label{ux521dux671fux5bc6ux5ea6ux540cux671fux3068ux306eux95a2ux4fc2}}
...
\item
  位相接続に沿う単流束化。
\item
  標本化後の活性場を同じコヒーレント部分空間へ戻す写像。
\item
  共有明反応座標と準備浴の反復可能な再初期化。
\end{enumerate}
...
\hypertarget{ux56faux5b9aux3055ux308cux305fux5bfeux30e2ux30fcux30c9}{%
\section{固定された対モード}\label{ux56faux5b9aux3055ux308cux305fux5bfeux30e2ux30fcux30c9}}
...
\hypertarget{ux7fa4ux306eux8aa4ux5dee}{%
\section{4群の誤差}\label{ux7fa4ux306eux8aa4ux5dee}}
...
\hypertarget{ux6e96ux5099ux8aa4ux5dee}{%
\section{準備誤差}\label{ux6e96ux5099ux8aa4ux5dee}}
...
\hypertarget{ux7e2eux7d04ux8aa4ux5dee}{%
\section{縮約誤差}\label{ux7e2eux7d04ux8aa4ux5dee}}
...
\item
  有効複素弱方程式の形式領域での正則性。
\item
  正則化接続 \(\boldsymbol a_\varepsilon\) の極限。
\item
  密度差と特異接続の重み付き積。
\item
  節近傍の粒子質量。
...
\hypertarget{ux4f4dux7f6eux5165ux53e3ux306eux6e2cux5b9aux8aa4ux5dee}{%
\section{位置入口の測定誤差}\label{ux4f4dux7f6eux5165ux53e3ux306eux6e2cux5b9aux8aa4ux5dee}}
...
\hypertarget{bell-ux6e2cux5b9aux8aa4ux5dee}{%
\section{Bell 測定誤差}\label{bell-ux6e2cux5b9aux8aa4ux5dee}}
...
\hypertarget{ux5468ux671fux8aa4ux5deeux3068ux5168ux8a66ux884cux76e3ux67fb}{%
\section{周期誤差と全試行監査}\label{ux5468ux671fux8aa4ux5deeux3068ux5168ux8a66ux884cux76e3ux67fb}}
...
\hypertarget{ux5c0eux51faux72b6ux614bux306eux4e00ux89a7}{%
\section{導出状態の一覧}\label{ux5c0eux51faux72b6ux614bux306eux4e00ux89a7}}
...
\item
  高速整合だけではコヒーレント集中しない。
\item
  コヒーレント集中だけでは粒子・場同期しない。
\item
  連続の式だけでは流束同期を保存できない。
\item
  複素弱形式を使うだけでは、ミクロ位相接続の節横断導出は完成しない。
\item
  \(H^1\) 型集中だけでは節集合の形と個数を保存できない。
\item
  固有状態を解として含むことは、その状態を選択または吸引することではない。
\item
  \(\kappa=\mathcal J_\phi^2/(2m)\) は内部回転対称性だけから従わない。
\item
  位置入口作用殻は一般 Born 則ではない。
\item
  正規化された殻内混合はセクター間の確率質量を作らない。
\item
  低ランク相関と局所回転だけでは Bell 頻度を作らない。
\item
  共通未来比較器は過去の記録を前向きに変更しない。
\item
  Bell 共同頻度には共通境界測度が必要である。
\item
  Bell 違反は測定設定独立性を満たさない完全履歴集団で生じる。
\item
  異なる記録を残したまま全自由度を同じ位相点へ戻す完全リセットは Hamiltonian ではない。
\item
  配置拡散・Nelson 経路は現行模型の前提ではない。
\end{enumerate}
...
\item
  高速欠陥ノルム。
\item
  \(\|R_{\rm red}\|_{L^1(0,T;\mathcal Q^*)}\) と、コヒーレント安定性に用いるエネルギー残差。
\item
  \(\|\rho-q\|_{H^{-1}}\)。
\item
  \(\|\boldsymbol J_{\rm p}-\boldsymbol j_\psi\|\) の時間積分。
\item
  節近傍の重み付き接続誤差。
\item
  有限セル幅、正則化幅、特異パラメータに対する収束。
\end{enumerate}
...
\tightlist
\item
  現行 M0 の有限時間発展から \(\varepsilon_{\rm mic}^{\rm wk}(T)\) と \(\varepsilon_{\rm mic}^{\mathcal E}(T)\) を導く。
\item
  半正定値位相 Hessian と零モードを含む低速・高速分離を示す。
\item
  時間依存射影と非線形高速再励起を制御する。
\item
  粒子速度分散と接続追従から流束差上界を導く。
\item
  節近傍の粒子質量、重み付き同期、正則化極限を制御する。
\item
  初期コヒーレント集中を有限 Hamiltonian 準備で作る。
\item
  位置入口標本化後の活性場をコヒーレント部分空間へ再埋め込みする。
\item
  反対称対モード源と長時間位相保持を構成する。
\item
  共通境界密度を事後選別なしに準備する。
\item
  設定生成、結果形成、増幅、記録、比較、リセットを1周期へ統合する。
\end{enumerate}
...
\hypertarget{ux6709ux9650ux30bbux30ebux6b63ux6e96ux5909ux63dbux3068ux5f31ux7e2eux7d04ux8a55ux4fa1ux306eux8a73ux7d30}{%
\chapter{有限セル正準変換と弱縮約評価の詳細}\label{ux6709ux9650ux30bbux30ebux6b63ux6e96ux5909ux63dbux3068ux5f31ux7e2eux7d04ux8a55ux4fa1ux306eux8a73ux7d30}}
...
\hypertarget{ux5c04ux5f71ux7684ux4ee3ux8868ux5834}{%
\section{射影的代表場}\label{ux5c04ux5f71ux7684ux4ee3ux8868ux5834}}
...
\hypertarget{ux5171ux901aux7ddaux5f62ux767aux5c55ux306bux5bfeux3059ux308bux6709ux9650ux6642ux9593ux5b89ux5b9aux6027}{%
\section{共通線形発展に対する有限時間安定性}\label{ux5171ux901aux7ddaux5f62ux767aux5c55ux306bux5bfeux3059ux308bux6709ux9650ux6642ux9593ux5b89ux5b9aux6027}}
...
\hypertarget{ux5f37ux5ea6ux3068ux5834ux6d41ux675fux306eux7a4dux8a55ux4fa1}{%
\section{強度と場流束の積評価}\label{ux5f37ux5ea6ux3068ux5834ux6d41ux675fux306eux7a4dux8a55ux4fa1}}
...
\hypertarget{ux5f31ux5bc6ux5ea6ux5deeux8a55ux4fa1}{%
\section{弱密度差評価}\label{ux5f31ux5bc6ux5ea6ux5deeux8a55ux4fa1}}
...
\hypertarget{ux7bc0ux3092ux542bux3080ux5f31ux5f62ux5f0fux3068ux63a5ux7d9aux6975ux9650}{%
\section{節を含む弱形式と接続極限}\label{ux7bc0ux3092ux542bux3080ux5f31ux5f62ux5f0fux3068ux63a5ux7d9aux6975ux9650}}
