...
共通有効モデルをM42、Q1装置をM38、一般有限基底補助をM35、Q2結合ゲートをM39、Q2 Bell周期をM41、Q3ミクロ振動子網をM37、Q3有限環境純位相緩和をM43と呼ぶ。M45は、周期反応座標と対数型捕捉エントロピー座標を開放Langevin方程式で動かし、定常基底状態の初期共通原因測度を準備できるかを調べる現行補助モデルである。M46は、同じlimit cycle、capacity、反応座標とM37/M42を接続し、三角形capacity loading、共通作用ポート、局所current transducerをphase-reducedミクロ開放方程式として採用する現行基礎モデルである。これらを1つのハードウェア、時計周期、反復母測度へまとめたM0は未完成である。
...
M46はこのうち第1項を模型固有のmatchingとして \(\mathcal J_0=\Theta/\omega_c=2m\nu\) と置き、M37のmatching Hamiltonianが保持する複素包絡の相対位相を局所current transducerへ渡す。ただしこの関係をM37の位置ばねHamiltonianだけから普遍的に導くのでなく、M45由来の開放作用尺度を接続したM46の予言として扱う。M37のHamiltonianと反回転項の評価は変更せず、準備modeの散逸選択と伝播modeのHamiltonian流を既存反応座標で分離する。完全な受渡しと一般時間依存Nelson則は第8.14節と付録Iに示す。
...
\item
  M46について、採用した三角形capacity方程式、半減衰、主共分散選択、current transducerを、具体的負性抵抗limit cycleと一つの入出力線から同じ係数で導けるかを判定する。任意複素状態の自律準備、node正則化、graph-to-continuum一様誤差は別の解析課題とする。
\end{enumerate}
...
\hypertarget{m46ux5171ux901aux4f5cux7528ux30ddux30fcux30c8ux578bux4e09ux89d2ux5f62capacity-currentux7d71ux5408ux958bux653eux6a21ux578b}{%
\section{M46共通作用ポート型三角形capacity-current統合開放模型}\label{m46ux5171ux901aux4f5cux7528ux30ddux30fcux30c8ux578bux4e09ux89d2ux5f62capacity-currentux7d71ux5408ux958bux653eux6a21ux578b}}
...
\hypertarget{m46ux3068ux306eux95a2ux4fc2}{%
\section{M46との関係}\label{m46ux3068ux306eux95a2ux4fc2}}
...
\hypertarget{ux5171ux901aux4f5cux7528ux30ddux30fcux30c8ux578bux4e09ux89d2ux5f62capacity-currentux7d71ux5408ux958bux653eux6a21ux578bux3068ux6642ux9593ux4f9dux5b58nelsonux6d41}{%
\chapter{共通作用ポート型三角形capacity-current統合開放模型と時間依存Nelson流}\label{ux5171ux901aux4f5cux7528ux30ddux30fcux30c8ux578bux4e09ux89d2ux5f62capacity-currentux7d71ux5408ux958bux653eux6a21ux578bux3068ux6642ux9593ux4f9dux5b58nelsonux6d41}}

\begin{statusbox}
位置づけ：第8.14節のM46とR130--R134について、phase-reduced開放方程式、指数capacity消去、半減衰、主共分散選択、局所current transducer、連続極限、時間対称Newton則を詳述する。
\end{statusbox}

\hypertarget{ux3053ux306eux4ed8ux9332ux306eux76eeux7684ux3068ux6a21ux578bux968eux5c64}{%
\section{この付録の目的と模型階層}\label{ux3053ux306eux4ed8ux9332ux306eux76eeux7684ux3068ux6a21ux578bux968eux5c64}}
...
M46は、この残る数学的鎖を閉じるために採用する\textbf{phase-reducedミクロ開放模型}である。M37のmatching Hamiltonian、M42の複素振幅場と実現配置、M45のlimit cycle、対数型capacity、準安定反応座標を再利用し、別の物理的latchまたは積分器を追加しない。追加するのは、消去後に仮定されていた三角形の開放結合を、採用方程式として明示することである。
...
\tightlist
\item
  対数型capacityの指数分布と局所loadingから、経路ごとのFeynman--Kac重みを導く。
\item
  同じ作用ポートのphase-preserving散逸から、古典的生存率 \(D\) に対する複素振幅の半減衰 \(A=D^{1/2}\) を導く。
\item
  複素slow covarianceの二成分を保持したまま主モードを選び、正の主固有関数だけを確率振幅の全情報と同一視しない。
\item
  matching Hamiltonianが作る相対位相を局所非負率へ符号化し、一般時間依存の \(v\)、\(S\)、前後drift、時間対称Newton則へ接続する。
\end{enumerate}
...
\hypertarget{ux6709ux9650ux30b0ux30e9ux30d5ux4f5cux7528ux5c3aux5ea6ux30ddux30c6ux30f3ux30b7ux30e3ux30ebux57faux6e96}{%
\section{有限グラフ、作用尺度、ポテンシャル基準}\label{ux6709ux9650ux30b0ux30e9ux30d5ux4f5cux7528ux5c3aux5ea6ux30ddux30c6ux30f3ux30b7ux30e3ux30ebux57faux6e96}}
...
\hypertarget{ux5171ux901alimit-cycleux3068ux5185ux90e8modeux8a18ux61b6}{%
\section{共通limit cycleと内部mode記憶}\label{ux5171ux901alimit-cycleux3068ux5185ux90e8modeux8a18ux61b6}}
...
\hypertarget{ux4e09ux89d2ux5f62ux958bux653eux65b9ux7a0bux5f0f}{%
\section{三角形開放方程式}\label{ux4e09ux89d2ux5f62ux958bux653eux65b9ux7a0bux5f0f}}
...
\hypertarget{ux6307ux6570capacityux3068ux4e09ux4fc2ux6570ux6574ux5408}{%
\section{指数capacityと三係数整合}\label{ux6307ux6570capacityux3068ux4e09ux4fc2ux6570ux6574ux5408}}
...
\hypertarget{r130ux6307ux6570capacityux6d88ux53bb}{%
\section{R130：指数capacity消去}\label{r130ux6307ux6570capacityux6d88ux53bb}}
...
\begin{theorem}[R130：三角形capacity消去とFeynman--Kac重み]
...
\hypertarget{r131ux751fux5b58ux7387ux304bux3089ux8907ux7d20ux632fux5e45ux306eux534aux6e1bux8870ux3078}{%
\section{R131：生存率から複素振幅の半減衰へ}\label{r131ux751fux5b58ux7387ux304bux3089ux8907ux7d20ux632fux5e45ux306eux534aux6e1bux8870ux3078}}
...
\begin{proposition}[R131：共通作用ポートの半減衰と対称共分散核]
...
\hypertarget{ux4e8cux5024thresholdux5358ux72ecux306eux9650ux754c}{%
\subsection{二値threshold単独の限界}\label{ux4e8cux5024thresholdux5358ux72ecux306eux9650ux754c}}
...
\hypertarget{r132ux4e3bux5171ux5206ux6563ux9078ux629eux3068ux5171ux901aux539fux56e0}{%
\section{R132：主共分散選択と共通原因}\label{r132ux4e3bux5171ux5206ux6563ux9078ux629eux3068ux5171ux901aux539fux56e0}}
...
\hypertarget{ux4e00ux65b9ux5411ux751fux5b58ux3068ux5e73ux65b9ux5bc6ux5ea6ux306eux533aux5225}{%
\subsection{一方向生存と平方密度の区別}\label{ux4e00ux65b9ux5411ux751fux5b58ux3068ux5e73ux65b9ux5bc6ux5ea6ux306eux533aux5225}}
...
\hypertarget{ux6e96ux5099ux304bux3089ux4f1dux64adux3078ux306eux53d7ux6e21ux3057}{%
\section{準備から伝播への受渡し}\label{ux6e96ux5099ux304bux3089ux4f1dux64adux3078ux306eux53d7ux6e21ux3057}}
...
\hypertarget{r133ux5c40ux6240current-transducer}{%
\section{R133：局所current transducer}\label{r133ux5c40ux6240current-transducer}}
...
\begin{theorem}[R133：局所非負rateによる辺流と前後drift]
...
\hypertarget{ux6642ux9593ux4f9dux5b58ux5bc6ux5ea6ux3068ux4f5cux7528ux4f4dux76f8}{%
\section{時間依存密度と作用位相}\label{ux6642ux9593ux4f9dux5b58ux5bc6ux5ea6ux3068ux4f5cux7528ux4f4dux76f8}}
...
\hypertarget{r134ux6642ux9593ux5bfeux79f0newtonux5247}{%
\section{R134：時間対称Newton則}\label{r134ux6642ux9593ux5bfeux79f0newtonux5247}}
...
\begin{theorem}[R134：一般時間依存Nelson流の時間対称Newton則]
...
\hypertarget{ux5c0eux51faux72b6ux614bux8aa4ux5deeux53cdux8a3cux6761ux4ef6}{%
\section{導出状態、誤差、反証条件}\label{ux5c0eux51faux72b6ux614bux8aa4ux5deeux53cdux8a3cux6761ux4ef6}}
...
\tightlist
\item
  capacity loadingが位置方程式へ \(O(1)\) の追加driftを返し、三角形極限が成立しない。
\item
  出力portが \(W\) と同次数の位相shiftを残し、\(A_\delta\) が正実対角作用素にならない。
\item
  capacity thresholdに独立なdump-line雑音が加わり、指数無記憶則または共通gainが壊れる。
\item
  準備modeと伝播modeの切替漏れが有限極限で残り、伝播中のcoherenceを減衰させる。
\item
  \(g\lambda_0\uparrow1\) で非線形共分散が主固有射影へ集中しない。
\item
  current transducerの対称往復流が拡散係数 \(\nu\) と一致しない、または反対称差が辺流と一致しない。
\item
  node正則化誤差が格子細分化で消えない。
\item
  graph-to-continuum極限で \(b_+=v+u\) が一様に得られない。
\end{enumerate}
