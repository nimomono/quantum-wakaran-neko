...
\hypertarget{ux8cc7ux6e90ux4e0aux754cux9054ux6210ux5224ux5b9aux7f6eux63dbux6e08ux307fm41ux3068ux306eux95a2ux4fc2}{%
\section{資源上界、達成判定、置換済みM41との関係}\label{ux8cc7ux6e90ux4e0aux754cux9054ux6210ux5224ux5b9aux7f6eux63dbux6e08ux307fm41ux3068ux306eux95a2ux4fc2}}
...
で抑えた。\(\varepsilon_{\rm prep}\) は鋭い基準配置からのsinglet型場・配置準備、\(\varepsilon_{\rm move}\) は配置通信路、\(\varepsilon_{\rm cond}\) はA結果に条件付けた2端準備に対応する。帰還側の逆写像とresetは \(\varepsilon_{\rm ret}\) として次周期へ渡した。項別の換算は置換済みM41研究メモと付録Fに残す。この式をM48の現行誤差へ流用しない。
...
置換済みM41 Bell周期 & 歴史的回帰として枝頻度、非選択B状態、Born型共同分布、非信号周辺、CHSH値がR107--R111と一致しない \\
