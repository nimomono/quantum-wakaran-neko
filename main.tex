...
\hypersetup{
  ...
  citecolor=PaperBlue,
  urlcolor=PaperBlue,
  pdftitle={構造化誘導場を持つ弱開放古典 Hamiltonian 系の二側縮約：運動量結合による配置拡散と境界作用殻 Bell 型統計},
...
\begin{titlepage}
  ...
  {\sffamily\bfseries\color{PaperNavy}\fontsize{21}{30}\selectfont
    ...
    二側縮約：運動量結合による配置拡散と\\[2mm]
    境界作用殻 Bell 型統計\par}
  \vspace{9mm}
  {\Large\color{PaperBlue}配置速度記憶、二側 Fisher 構造、U(3) 等方拡散、Bell 型残余ファイバー体積\par}
  \vspace{14mm}
  {\color{PaperRule}\rule{0.68\textwidth}{0.9pt}\par}
  \vfill
  {\large draft-14 改訂稿\par}
  \vspace{22mm}
\end{titlepage}
...
\tightlist
\item
  粒子と構造化誘導場を運動量で結合したとき、場の速度揺らぎから配置空間の二側拡散と Fisher 項が生じるか。
\item
  同じ構造化誘導場を2粒子、左右測定器、共通境界モードへ拡張したとき、境界作用殻の測度から Bell 型共同確率が生じるか。
\end{enumerate}
...
\hypertarget{ux7a2eux985eux306eux76f4ux63a5ux7d50ux5408}{%
\section{2種類の直接結合}\label{ux7a2eux985eux306eux76f4ux63a5ux7d50ux5408}}
...
\hypertarget{h-ux904bux52d5ux91cfux7d50ux5408-hamiltonian}{%
\subsection{{[}H{]} 運動量結合 Hamiltonian}\label{h-ux904bux52d5ux91cfux7d50ux5408-hamiltonian}}
...
\hypertarget{g-ux8a98ux5c0eux5834ux306eux6b63ux78baux306aux6d88ux53bb}{%
\subsection{{[}G{]} 誘導場の正確な消去}\label{g-ux8a98ux5c0eux5834ux306eux6b63ux78baux306aux6d88ux53bb}}

\(Y_N=C_N\Pi\) を自由速度揺らぎと反作用記憶項へ分ける。初期値消去と、一意可解な二側境界条件の Green 消去は線形核内部の厳密結果である。

\hypertarget{d-ux914dux7f6eux62e1ux6563ux6975ux9650}{%
\subsection{{[}D{]} 配置拡散極限}\label{d-ux914dux7f6eux62e1ux6563ux6975ux9650}}

多数モード、短記憶、再帰前の観測窓で、自由速度揺らぎの積分を Brown 運動へ近づける。反作用記憶、異方性、有限切断、弱開放補正を同時に評価する。この条件は未完成である。

\hypertarget{x-ux914dux7f6e-markov-ux9589ux9396}{%
\subsection{{[}X{]} 配置 Markov 閉鎖}\label{x-ux914dux7f6e-markov-ux9589ux9396}}

位相空間の有効過程から、配置変数だけの前進・後退 Markov 拡散を得る。前後の2次変分が同じ \(\nu\) を持ち、条件付き速度分散が余分な古典圧力を残さない範囲を示す。この条件は未完成である。

\hypertarget{n-ux6642ux9593ux5bfeux79f0ux52d5ux529bux5b66}{%
\subsection{{[}N{]} 時間対称動力学}\label{n-ux6642ux9593ux5bfeux79f0ux52d5ux529bux5b66}}
...
\hypertarget{b1-ux5168ux4ea4ux5deeux5fdcux7b54ux306eux6291ux5236}{%
\subsection{{[}B1{]} 全交差応答の抑制}\label{b1-ux5168ux4ea4ux5deeux5fdcux7b54ux306eux6291ux5236}}
...
\tightlist
\item
  \textbf{欠陥除去と入口準備}：前試行の記録と欠陥成分を除き、粒子、誘導場、装置を指定した入口巨視領域へ戻す。
\item
  \textbf{殻準備}：Bell 側の境界3モードの総作用を狭い分布へ置き、Hamiltonian な殻接方向混合で方向の偏りを緩和する。
\item
  \textbf{生成源と設定準備}：位相基準、伝達ベクトル対、左右設定制御器を準備する。
\item
  \textbf{局所発展と記録}：全交差応答が小さい窓で局所結果を形成し、指針へ記録する。
\item
...
\part{運動量結合した構造化誘導場の配置拡散縮約}

\hypertarget{ux904bux52d5ux91cfux7d50ux5408ux3057ux305fux7c92ux5b50ux69cbux9020ux5316ux8a98ux5c0eux5834ux5916ux90e8ux6d41ux8def}{%
\chapter{運動量結合した粒子、構造化誘導場、外部流路}\label{ux904bux52d5ux91cfux7d50ux5408ux3057ux305fux7c92ux5b50ux69cbux9020ux5316ux8a98ux5c0eux5834ux5916ux90e8ux6d41ux8def}}
...
\hypertarget{ux6b63ux5b9aux5024ux6761ux4ef6}{%
\section{正定値条件}\label{ux6b63ux5b9aux5024ux6761ux4ef6}}
...
\hypertarget{hamilton-ux65b9ux7a0bux5f0fux3068ux914dux7f6eux901fux5ea6}{%
\section{Hamilton 方程式と配置速度}\label{hamilton-ux65b9ux7a0bux5f0fux3068ux914dux7f6eux901fux5ea6}}
...
\hypertarget{ux6642ux9593ux53cdux8ee2ux5bfeux79f0ux6027}{%
\section{時間反転対称性}\label{ux6642ux9593ux53cdux8ee2ux5bfeux79f0ux6027}}
...
\hypertarget{ux9078ux629eux7684ux306aux5f31ux6f0fux308cux3068ux6642ux9593ux7a93}{%
\section{選択的な弱漏れと時間窓}\label{ux9078ux629eux7684ux306aux5f31ux6f0fux308cux3068ux6642ux9593ux7a93}}
...
\tightlist
\item
  \(\int_0^tY_N(s)\,\mathrm ds\) が Brown 運動へ近づくこと。
\item
  反作用記憶項が局所ドリフトまたは制御可能な残差へ縮約されること。
\item
  配置変数 \(X\) だけの射影が Markov 過程になること。
\item
  二側条件付け後の前後過程が同じ拡散係数を持つこと。
\item
  Nelson の時間対称 Newton 則が成立すること。
\item
...
\hypertarget{ux914dux7f6eux6d41ux675fux8a98ux5c0eux5834ux306eux6b63ux78baux306aux6d88ux53bbux901fux5ea6ux8a18ux61b6ux6838}{%
\chapter{配置流束、誘導場の正確な消去、速度記憶核}\label{ux914dux7f6eux6d41ux675fux8a98ux5c0eux5834ux306eux6b63ux78baux306aux6d88ux53bbux901fux5ea6ux8a18ux61b6ux6838}}
...
\hypertarget{ux914dux7f6eux5bc6ux5ea6ux3068ux6b63ux78baux306aux914dux7f6eux6d41ux675f}{%
\section{配置密度と正確な配置流束}\label{ux914dux7f6eux5bc6ux5ea6ux3068ux6b63ux78baux306aux914dux7f6eux6d41ux675f}}
...
\hypertarget{ux6b63ux6e96ux904bux52d5ux91cfux3068ux914dux7f6eux901fux5ea6ux306e1ux6b21ux30e2ux30fcux30e1ux30f3ux30c8}{%
\section{正準運動量と配置速度の1次モーメント}\label{ux6b63ux6e96ux904bux52d5ux91cfux3068ux914dux7f6eux901fux5ea6ux306e1ux6b21ux30e2ux30fcux30e1ux30f3ux30c8}}
...
\hypertarget{ux8ceaux91cfux898fux683cux5316ux3057ux305fux7ddaux5f62ux8a98ux5c0eux5834}{%
\section{質量規格化した線形誘導場}\label{ux8ceaux91cfux898fux683cux5316ux3057ux305fux7ddaux5f62ux8a98ux5c0eux5834}}
...
\hypertarget{ux521dux671fux5024ux554fux984cux3067ux306eux6b63ux78baux306aux6d88ux53bb}{%
\section{初期値問題での正確な消去}\label{ux521dux671fux5024ux554fux984cux3067ux306eux6b63ux78baux306aux6d88ux53bb}}

前節の2階方程式を初期値で解くと、

\begin{proposition}[誘導場運動量の正確な初期値消去]
...
\hypertarget{ux81eaux7531ux901fux5ea6ux63faux3089ux304eux306eux76f8ux95a2}{%
\section{自由速度揺らぎの相関}\label{ux81eaux7531ux901fux5ea6ux63faux3089ux304eux306eux76f8ux95a2}}
...
\hypertarget{ux914dux7f6eux5909ux4f4dux306eux62e1ux6563ux6975ux9650}{%
\section{配置変位の拡散極限}\label{ux914dux7f6eux5909ux4f4dux306eux62e1ux6563ux6975ux9650}}
...
\hypertarget{ux6b63ux78baux306aux7d50ux679cux3068ux7e2eux7d04ux8ab2ux984c}{%
\section{正確な結果と縮約課題}\label{ux6b63ux78baux306aux7d50ux679cux3068ux7e2eux7d04ux8ab2ux984c}}
...
\hypertarget{ux4e8cux5074ux914dux7f6eux62e1ux6563fisher-ux9805ux6642ux9593ux5bfeux79f0ux52d5ux529bux5b66}{%
\chapter{二側配置拡散、Fisher 項、時間対称動力学}\label{ux4e8cux5074ux914dux7f6eux62e1ux6563fisher-ux9805ux6642ux9593ux5bfeux79f0ux52d5ux529bux5b66}}

\begin{statusbox}
位置づけ：配置変数の二側 Markov 拡散を仮定した後の浸透速度、Fisher 情報、量子ポテンシャルは厳密結果である。運動量結合した有限誘導場からの配置拡散極限と時間対称 Newton 則は独立した未解決問題である。
\end{statusbox}

\hypertarget{ux914dux7f6eux96d1ux97f3ux3092ux6301ux3064ux4f4dux76f8ux7a7aux9593ux6975ux9650}{%
\section{配置雑音を持つ位相空間極限}\label{ux914dux7f6eux96d1ux97f3ux3092ux6301ux3064ux4f4dux76f8ux7a7aux9593ux6975ux9650}}
...
\hypertarget{ux914dux7f6eux5909ux6570ux3060ux3051ux306eux4e8cux5074-markov-ux62e1ux6563}{%
\section{配置変数だけの二側 Markov 拡散}\label{ux914dux7f6eux5909ux6570ux3060ux3051ux306eux4e8cux5074-markov-ux62e1ux6563}}
...
\hypertarget{ux73feux5728ux901fux5ea6ux3068ux6d78ux900fux901fux5ea6}{%
\section{現在速度と浸透速度}\label{ux73feux5728ux901fux5ea6ux3068ux6d78ux900fux901fux5ea6}}
...
\hypertarget{fisher-ux60c5ux5831ux3068ux91cfux5b50ux30ddux30c6ux30f3ux30b7ux30e3ux30eb}{%
\section{Fisher 情報と量子ポテンシャル}\label{fisher-ux60c5ux5831ux3068ux91cfux5b50ux30ddux30c6ux30f3ux30b7ux30e3ux30eb}}
...
\hypertarget{ux6642ux9593ux5bfeux79f0-newton-ux5247ux306fux72ecux7acbux3057ux305fux4e3bux5f35ux3067ux3042ux308b}{%
\section{時間対称 Newton 則は独立した主張である}\label{ux6642ux9593ux5bfeux79f0-newton-ux5247ux306fux72ecux7acbux3057ux305fux4e3bux5f35ux3067ux3042ux308b}}
...
\hypertarget{ux5c40ux6240ux7684ux306a-schruxf6dinger-ux8868ux793a}{%
\section{局所的な Schrödinger 表示}\label{ux5c40ux6240ux7684ux306a-schruxf6dinger-ux8868ux793a}}
...
この局所変換は、節をまたぐ位相接続、循環量子化、単価な波動関数を保証しない。従って Wallstrom 問題は未解決である \cite{wallstrom1994}。

\hypertarget{ux914dux7f6eux62e1ux6563ux6975ux9650ux306eux8aa4ux5dee}{%
\section{配置拡散極限の誤差}\label{ux914dux7f6eux62e1ux6563ux6975ux9650ux306eux8aa4ux5dee}}
...
\begin{theorem}[線形 Gauss 型作用の <i>C</i><sup>1</sup> 極限]
...
\item
  運動量結合方向と装置の座標結合方向から、時間に依存しない明・暗モード基底を定める。
\item
  局所測定窓では、座標--座標核と運動量--座標混合核を含む左右交差応答が小さいことを条件にする。
\item
...
まず \(\varepsilon_{\rm nl}=0\) の線形浴を考える。装置の座標結合だけを取り出して浴を消去すると、局所反応座標には自己応答と交差応答を含む記憶項が現れる \cite{ford1965,mori1965,zwanzig1973}。単位質量表示では、座標--座標の代表核を
...
\hypertarget{ux914dux7f6eux62e1ux6563ux5074ux306eux8aa4ux5dee}{%
\section{配置拡散側の誤差}\label{ux914dux7f6eux62e1ux6563ux5074ux306eux8aa4ux5dee}}
...
\item
  運動量結合が配置速度揺らぎを作っても、その積分が Brown 運動へ収束するとは限らない。
\item
  \((X,P)\) の位相空間過程が Markov でも、\(X\) だけの射影は一般に Markov ではない。
\item
  二側配置拡散から Fisher 項が得られても、時間対称 Newton 則は自動的に従わない。
\end{enumerate}
...
\tightlist
\item
  運動量結合した有限誘導場から、再帰前の観測窓で配置変位の Brown 極限を導く。
\item
  反作用記憶を質量繰り込み、局所ドリフト、制御可能な残差へ分け、一様誤差を評価する。
\item
  位相空間過程から配置変数だけの二側 Markov 拡散を導き、共通拡散係数と非 Markov 残差を評価する。
\item
  条件付き速度分散が余分な古典圧力を残さない条件を示す。
\item
  時間対称 Green 応答と条件付き変分から Nelson の時間対称 Newton 則を導く。
\item
  固定位相整合射影と欠陥射影を保ったまま、欠陥成分だけの減衰と再帰抑制を外部スペクトルから導く。
\item
  同じ誘導場の運動量--座標混合核を含む全交差応答を評価し、局所測定窓で抑える。
\item
