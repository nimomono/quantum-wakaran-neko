@number: 2
@chapter: 本文
@title: 有限正準制御、M51開放準備、M50有限枝instrument
@status: R112、R171、R135、R161、R162、R164、R168、R170をQ1・Q2・Q3の共通主線として整理する。有限正準制御、比較、記録はR112へ、階数1統計状態の準備はM51/R171へ、Born型枝生成はM50/R164へ分ける。
