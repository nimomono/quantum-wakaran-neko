...
## 2.9 R170：M54静的状態構成固定入力時刻有限枝測定機構
...
## 2.13 M54 共通射影選別機構：射影結果の固定機構・選択・固定・可逆選別機構
...
## 2.14 R181D：R170駆動段階的射影選別 Born 測定機構
...
## 2.16 R179：一様未使用-貯蔵部・衝突-素子・使用済み供給定理
...
証明、sub-Gaussian製造ばらつきの最大偏差系、compute--uncompute診断は付録Rに置く。
## 2.17 M54の合成誤差と資源
