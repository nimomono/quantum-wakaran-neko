@number: I
@chapter: 付録
@title: Q3-3からQ3-5の完成証明
@status: R123--R125について、1次元低位束縛状態と有限環境純位相緩和、障壁値未満状態の確率移動、最小2経路干渉を証明し、後2者をM42の固定時刻位置読出しへ接続する。
