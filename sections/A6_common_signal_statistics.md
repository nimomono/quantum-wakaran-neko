@number: F
@chapter: 付録
@title: 共通信号集団とM54 static ray平均の証明
@status: 共通R135の正確輸送、有限時間誤差、階数1支持と、一般ray平均定理R168を証明する。Q3ではM37包絡誤差をR135へ代入する統計診断として扱い、R168/R170のstatic固定時刻instrumentをM54 spatial連続粒子経路と区別する。
