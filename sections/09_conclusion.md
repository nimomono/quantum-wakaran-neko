...
@chapter: 本文
@title: 結論
@status: M54/M37の現行信号階層、Q1型局所信号＋Q2型辺結合からQ3空間 $(\pi,j)$ への接続、Q1/Q2のR191 2結果読出し、Q2-2の2端逐次R191、Q3のM60/R199A・R195A・R196A--R196C--R161--R185位置経路（R162はideal reference）を総括する。
