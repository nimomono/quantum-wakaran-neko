...
零でないM54末端信号を正準SWAPで $\widetilde V=v$ と保持し、解析上だけ $V=\widetilde V/\|\widetilde V\|$ とする。A設定 $x$ に応じた $U_x^\dagger\otimes I_2$、第2.13節の直交射影子作用保持機構で2結果の物理容量を保持し、その容量をR164--R190--R179の静的選択とR170 指針変数固定へ渡す。共通補題が保持する物理結果成分容量を
