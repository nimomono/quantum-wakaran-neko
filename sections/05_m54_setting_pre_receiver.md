...
R180AのM54 信号 保持、射影結果の固定機構、結果成分作用殻、選択ブロックの接続端、R180Bのテンプレート 保持、ポンプ、排出先、2翼信号系、中央切断、および2つの局所R170が共通の安全集合と1つの有限時計自由度 時刻割当上で上式の各誤差以内に実行できるとする。完全結果集合を
...
M54静的状態構成、設定先行2端Hopf受信機構と、R112、R161、R162、R164、R170、R181A--R181D、R180A--R180Cにより、固定一重項、固定有限設定族、準備先行、非空間分離、手順上の整合、無反応込み、採用開放法則、弱開放帰還という範囲で固定目標Q2-2を条件付き達成とする。
