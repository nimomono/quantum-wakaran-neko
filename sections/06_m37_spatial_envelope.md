...
@status: M37の正確局所方程式、生成子誤差、有限時間Schrödinger型近似をR86へ保ち、その下流に単一試行の局在粒子トークンM42を置く。M54準備、M37担体、R172--R174の等変輸送、有限衝突bath、終位置記録を二層模型として接続する。
