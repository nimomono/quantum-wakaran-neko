...
@status: M37の正確局所方程式とR86を保ち、Q3 空間信号部分系に加えて、R187で弱結合W型最低2モードをM54 W2 静的状態構成のQ1制御信号系へ有限誤差で接続する。測定・準備・M0統合は別課題とする。
...
## 6.14 R184のM37・有限衝突受渡しとQ3-4A・Q3-5
...
### 6.19.5 M54 W2 静的状態構成への正準状態の受け渡し
