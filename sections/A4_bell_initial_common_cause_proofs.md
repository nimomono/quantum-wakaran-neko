...
@status: 本文第7章のR107からR111を支える。設定前基準測度、階数2作用読出し、A担体準備、Bブロック正準SWAP、可変作用測定、外部記録、逆計算、積Haar長期頻度、singlet固定作用特殊化を明示する。4モード状態全体の2部分系分配、空間輸送、準備後の設定変更、一般Tsirelson原理は扱わない。
