...
2. 完全な2作用殻Liouville測度全体が有限時間の有限局所Hamiltonian力学で一様またはGibbs的に準備されること。R190は無限Drude浴を採用した条件でcollisionに必要な作用比 $I/A$ の一様化だけを扱う。
