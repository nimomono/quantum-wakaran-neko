...
@chapter: 付録
@title: Q2永続共同浴の合成契約
@status: R181Bの反復テンソル積状態の生成、R181Cの同一8モード状態浴、R181DのQ1向け段階的測定後状態受渡し、R177のGHZ--T--逆演算証人を統合する。Q2-2の旧R180逐次Bell受信機構はdraft-135で退役し、現行Q2-2はM66/R205--R207を使う。
...
を推定して $Z_{AB}$、$Z_{ABC}$ へ戻す操作は再準備である。Q2-1、Q2-3の状態受渡しには使わない。旧M48および後継R180 Bell周期は現行Q2-2根拠から退役し、Q2-2はM66/R205--R207を使う。
