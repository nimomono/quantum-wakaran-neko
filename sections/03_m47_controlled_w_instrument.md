...
@status: 旧M47で扱ったQ1系列をM54 W2 静的状態構成上の系列固有手順として整理し、R187のM37物理信号系、R181A準備、R140操作、R181Dの深さ1読出し、R143状態更新へ接続する。測定統計は導出済み、Zeno効果はQ1-2の残件である。
