...
@status: 旧M47で扱ったQ1系列をM54のW2静的状態構成上の系列固有手順として整理し、R187のM37物理信号系、R181A準備、R140操作、R143のW型1段測定特殊化、R181Dの階数1測定後状態の受け渡し、R144の固定有限段逐次測定へ接続する。測定統計は導出済み、Zeno効果はQ1-2の残件である。
