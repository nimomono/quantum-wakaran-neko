...
@status: M35について、固定純粋準備・固定有限基底・一般有限Lの局所基底回路、滑らかな比較、無反応結果、測定後状態、内部逆計算、無理数回転Poincaré 写像を構成する。M38で閉じたQ1-1からQ1-4と分離し、一般有限Lの外部記録、弱開放 reset、逐次基底一般化はM35の一般化課題として残す。
