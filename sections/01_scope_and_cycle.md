...
| Q2-4 | M54、R112、R161、R164、R170、R179、R181A--R181D、R186、R190A--R190C | $L=2^n$ の受動直接モード、一様open bath interface、逐次2結果選別機構 | 一般回路列と完全結果空間上の逐次出力。有限cold/spent bankは要求しない |
| Q3 | M54空間状態構成、M37、R86、R135、R161、R162 | 準備終了面のM37標本と初期配置＋開放Poisson jump bath | R184の粒子輸送、R185 Nelson縮約、R123--R125への接続 |
