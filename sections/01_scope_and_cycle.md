...
@status: M54をQ1・Q2・Q3の共通有効信号構成族、M37を物理信号実装層、M60をQ3共通ミクロ物理層として区別する。Q1/Q2のR191射影読出しとQ3のM60/R198A--R198D・R199A・R195A・R196A--R196C--R161位置輸送は結果形成として分離し、R161自身が有限状態canonical Markov経路法則まで与える。R162はそのoptional independent-Poisson realizationとしてのみ扱いつつ、Q1型局所正準信号とQ2型2体系結合からQ3空間信号の $(\pi,j)$ を作る共通構造を明示する。
