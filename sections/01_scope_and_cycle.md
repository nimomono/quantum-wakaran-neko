...
@chapter: 本文
@title: 記述層、測度、主結果の範囲
@status: M38の2モード完全装置、M37の空間振動子網、M35の一般有限基底装置、M36のBell 二側履歴を分離する。Q1は厳密、Q2とQ3は制御された任意精度、Q9は弱結合・有限時間で達成とする。Q5とQ7は部分達成であり、未構成のM0と統一母測度を現行定理の仮定に使わない。
