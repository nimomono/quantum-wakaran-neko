...
@status: M47の基礎として、実現配置--浴共同統計、開放Hopf準備、閉鎖作用角伝播、左右占有振動、条件付き閉包、枝別matching、逆設計存在構成を詳述する。
...
Q1への拡張は、R139のBloch縮約、R140の傾斜制御、R141の左右占有周辺固定、R142の左右読出し、R143の局所記録instrument、R144の条件付き周期である。R139--R144の定理文と証明は第3章と付録Bへ置き、本付録ではその入力となるM47共同統計構造を定める。
